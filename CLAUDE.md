...
**CLI path: `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe`** — use this exact path for every hyperresearch command. It may not be on your system PATH.
...
```bash
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe run status -j                 # Newest run: step status, spend, escalation queue depth
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe run resume -j                 # Exact next step + Skill invocation to continue with
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe run report -j                 # Per-step wall-time / spend / event telemetry
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe run verify <vault_tag> -j     # Ship gate: headings, length, citation density, cite-check resolution
```
...
```bash
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe scholar search "<query>" --limit 25 -j          # every available source, deduplicated
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe scholar search "<query>" --scope papers -j      # literature only, no trials/filings/series
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe scholar search "<query>" -s openalex -s core -j # pick specific sources
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe scholar sources -j                              # what is available, what each covers
```
...
`C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe fetch` auto-detects PDF URLs (arXiv, NBER, SSRN, direct `.pdf` links) and extracts full text via pymupdf. Fetch them aggressively. Raw PDFs land in `research/raw/<note-id>.pdf` and the note's frontmatter links back via `raw_file:`.
...
- `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note show <id> -j` carries an `oa` block with `body_is_not_from_source: true`,
...
```bash
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe search "query" --json                # Full-text search
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe search "query" --tag ml --json       # Filter by tag / status / date / parent
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe search "query" --include-body --json # Full-body search, not just titles
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note show <id> --json                # Read one note
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note show <id1> <id2> <id3> --json   # Batch-read notes in one call
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note list --json                     # List all notes with summaries
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe tags --json                          # Existing tag vocabulary
```
...
`C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note show <id>` (single, batch, or `-j`) or via `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe search`
...
```bash
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe fetch "<url>" --tag <topic> --save-assets -j   # Saves screenshot + top images
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe assets list --note <note-id> --json            # Assets for a specific note
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe assets path <note-id> --type screenshot -j     # Get screenshot path (viewable with Read)
```
...
If a fetch returns a login wall, tell the user to run `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe setup` and create a login profile.
...
```bash
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note list --status draft -j                                        # Find unprocessed notes
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note show <id> -j                                                  # Read the content
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe note update <id> --summary "<specific summary>" --add-tag <t> -j   # Add summary + tags
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe lint -j                                                            # Find missing tags / summaries / broken links
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe repair -j                                                          # Auto-fix broken links, rebuild indexes
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe sources score -j                                                   # Enrich DOI-bearing sources (citations, venue, retractions) + recompute quality
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe graph rank -j                                                      # Recompute vault PageRank centrality
C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe status -j                                                          # Overall vault health
```

Lifecycle: `draft` → `review` → `evergreen` (or `stale` → `deprecated` → `archive` for outdated material).

Summaries must be specific — "Mamba achieves linear-time sequence modeling via selective state spaces" beats "Paper about Mamba". Reuse the existing tag vocabulary (`C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe tags -j`) rather than inventing new tags.

### Key conventions

- Notes live in `research/notes/` as markdown with YAML frontmatter
- Link notes with `[[note-id]]` syntax
- After editing `.md` files directly, run `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe sync` to update the index
- Run `C:/Users/David/AppData/Local/Programs/Python/Python312/Scripts/hyperresearch.exe --help` for the full command list
<!-- hyperresearch:end -->
