...
- **Context Engine** — météo + arbitres + kilométrage déplacements (partial: ✅ météo Open-Meteo bd `cy9h` commit `db479aa` + ✅ arbitres BSD bd `82th` + Sofascore bd `qm6a` Plan D · ⏳ kilométrage déplacements pending)
