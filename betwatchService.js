...
function fetchMatchWOM(match) {
  ...
  return {
    source: 'betwatch', ts: (_cache && _cache.ts) || null,
...
function fetchMatchRows(match) {
  ...
  return [{
    key: 'betfairexchange', title: 'Betfair Exchange (betwatch)', isANJ: false,
...
module.exports = { enabled, status, fetchMatchWOM, fetchMatchRows, mergeRows, _find };
