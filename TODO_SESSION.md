...
- [ ] Fiches joueur accessibles via tableau Matchs : brainstorming experts équipe agents (.claude/agents/) + échanges améliorations/innovations sur fiche joueur + propositions à valider DG + correctifs récupération photo joueur (route /api/v1/player existante server.js:8241, vérifier source photo Sofascore/BSD + fallback CDN flagcdn) + rapport écrit du brainstorm + proposition d'améliorations livrable dans .context/PLAYER-CARDS-INNOVATIONS-2026.md
