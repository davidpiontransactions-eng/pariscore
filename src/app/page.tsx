  ...
  return (
    <PageErrorBoundary>
      <div className="min-h-screen flex flex-col bg-bg-deep pb-16 md:pb-0">
        ...
        <section className="sport-ambient max-w-7xl mx-auto w-full px-4 sm:px-6 pt-6" data-sport={activeTab}>
          <BentoGrid cols={4}>
            {/* Hero tile — 2×2 */}
        ...
        <section className="max-w-7xl mx-auto w-full px-4 sm:px-6 pt-8">
          <BentoGrid cols={4}>
            <BentoTile size="wide" variant="glass">
