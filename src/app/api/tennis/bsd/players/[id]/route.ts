...
import { fetchPlayer } from "@/lib/bsd-tennis-service";

const CACHE_TTL_MS = 5 * 60_000;
type CachedPayload = { data: unknown };
const cache = createTtlCache<CachedPayload>("__bsdPlayerDetailCache");
...
export async function GET(
  ...
  try {
    ...
    return apiErrorHandler(err, "bsd/players/[id]");
  }
}
