...
export type BSDFootballMatch = {
  ...
  odds_dnb_home?: number | null;
  odds_dnb_away?: number | null;
...
function mapLiveState(m: BSDFootballMatch): FootballLiveState | null {
  ...
  return {
    ...
    awayShotsOnTarget: num(ls?.away?.shots_on_target),
    homeCorners: num(ls?.home?.corner_kicks),
    awayCorners: num(ls?.away?.corner_kicks),
