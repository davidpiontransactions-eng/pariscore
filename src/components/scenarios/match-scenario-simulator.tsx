      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-lg border border-border/60 bg-muted/40 px-3 py-2 text-base sm:text-xs font-medium text-foreground outline-none transition-colors focus:border-accent/50 focus-visible:ring-1 focus-visible:ring-accent/20"
          >
            {SURFACES.map((s) => (
