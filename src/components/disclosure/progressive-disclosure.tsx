...
export function ProgressiveDisclosure({
  ...
  const level3 = (
    ...
    >
      <DialogContent className="p-6 sm:p-8 max-w-2xl max-sm:top-auto max-sm:bottom-0 max-sm:left-0 max-sm:right-0 max-sm:translate-x-0 max-sm:translate-y-0 max-sm:rounded-t-2xl max-sm:rounded-b-none max-sm:mt-auto max-sm:w-full">
