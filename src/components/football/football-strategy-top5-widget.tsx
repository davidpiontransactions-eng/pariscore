...
export const STRATEGIES: StrategyDef[] = [
  ...
  { key: "doubleChance1X", label: "Double Chance 1X", emoji: "🛡️", isProb: true, format: (v) => `${v.toFixed(0)}%` },
  { key: "doubleChance2X", label: "Double Chance 2X", emoji: "🛡️", isProb: true, format: (v) => `${v.toFixed(0)}%` },
  { key: "doubleChance12", label: "Double Chance 12", emoji: "⚡", isProb: true, format: (v) => `${v.toFixed(0)}%` },
