 ...
 * tennis (prematch + live, date, heures, recherche, Top, pills) + Top 10
 * par stratégie. Clic ligne → popup détail (live ou prematch, comme le foot).
 */
        ...
        <div className="border-t px-4 py-3" style={{ borderColor: C.cardBorder }}>
          {isLoading ? (
            ...
            <FotmobCalendarTable
              ...
              onTopPillSelect={handleTopPillSelect}
            />
          )}
        </div>
      </section>
